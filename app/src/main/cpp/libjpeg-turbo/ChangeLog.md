...
whereby j could cause compiler warnings of the form
...
distributions.  This was due to the addition of a macro in j that
...
because libjpeg-turbo's distributed version of j contained an `INLINE`
macro, which conflicted with a similar macro in DevIL.  This macro is used only
internally when building libjpeg-turbo, so it was moved into .
