...
#include "com_test_jnihelloworld_CompressUtil.h"
...
JNIEXPORT jint JNICALL Java_com_test_jnihelloworld_CompressUtil_compressBitmap
 ...
 char *fileName = jstrinTostring(env, fileNameBytes_);    //4、采用Libjpeg进行压缩
...
typedef struct my_error_mgr *my_error_ptr;struct my_error_mgr {
